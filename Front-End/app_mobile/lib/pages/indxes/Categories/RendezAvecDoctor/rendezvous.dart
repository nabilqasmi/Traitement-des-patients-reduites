                  ...
                  showDialog(
                      ...
                      builder: (BuildContext context){
                        return const AlertDialog(
                          title: Column(
                            children: [
                              Text("Dr.Jacklin Frenando ",style: TextStyle(fontWeight: FontWeight.bold),),
                              Text("a été ajouteé avec succès")
                            ],
                          ),
                        );
                      }
                  ...
                  showDialog(
                      ...
                      builder: (BuildContext context){
                        return const AlertDialog(
                          title: Column(
                            children: [
                              Text("Dr.Arlando Torres ",style: TextStyle(fontWeight: FontWeight.bold),),
                  ...
                  showDialog(
                      ...
                      builder: (BuildContext context){
                        return const AlertDialog(
                          title: Column(
                            children: [
                              Text("Dr.Kibaro bourrada ",style: TextStyle(fontWeight: FontWeight.bold),),
                              Text("a été ajouté avec succès")
                            ],
                          ),
                        );
                  ...
                  showDialog(
                      ...
                      builder: (BuildContext context){
                        return const AlertDialog(
                          title: Column(
                            children: [
                              Text("Dr.Boito arne ",style: TextStyle(fontWeight: FontWeight.bold),),
                              Text("a été ajouté avec succès")
                            ],
                          ),
                        );
                  ...
                  showDialog(
                      ...
                      builder: (BuildContext context){
                        return const AlertDialog(
                          title: Column(
                            children: [
                              Text("Dr.Stephane Albert ",style: TextStyle(fontWeight: FontWeight.bold),),
                              Text("a été ajouté avec succès")
                            ],
                          ),
                        );
                  ...
                  showDialog(
                      ...
                      builder: (BuildContext context){
                        return const AlertDialog(
                          title: Column(
                            children: [
                              Text("Dr.Jacob Brikado ",style: TextStyle(fontWeight: FontWeight.bold),),
                              Text("a été ajouté avec succès")
                            ],
                          ),
                        );
                  ...
                  showDialog(
                      ...
                      builder: (BuildContext context){
                        return const AlertDialog(
                          title: Column(
                            children: [
                              Text("Dr.Ayhan Miki ",style: TextStyle(fontWeight: FontWeight.bold),),
                              Text("a été ajouté avec succès")
                            ],
                          ),
                        );
                  ...
                  showDialog(
                      ...
                      builder: (BuildContext context){
                        return const AlertDialog(
                          title: Column(
                            children: [
                              Text("Dr.Paoula Etou ",style: TextStyle(fontWeight: FontWeight.bold),),
                              Text("a été ajouteé avec succès")
                            ],
                          ),
                        );
                  ...
                  showDialog(
                      ...
                      builder: (BuildContext context){
                        return const AlertDialog(
                          title: Column(
                            children: [
                              Text("Dr.Andrei Khrinanto ",style: TextStyle(fontWeight: FontWeight.bold),),
                              Text("a été ajouté avec succès")
                            ],
                          ),
                        );
                  ...
                  showDialog(
                      ...
                      builder: (BuildContext context){
                        return const AlertDialog(
                          title: Column(
                            children: [
                              Text("Dr.Afayn Hansika ",style: TextStyle(fontWeight: FontWeight.bold),),
                              Text("a été ajouté avec succès")
                            ],
                          ),
                        );
                  ...
                  showDialog(
                      ...
                      builder: (BuildContext context){
                        return const AlertDialog(
                          title: Column(
                            children: [
                              Text("Dr.Lucia Alger ",style: TextStyle(fontWeight: FontWeight.bold),),
                              Text("a été ajouteé avec succès")
                            ],
                          ),
                        );
